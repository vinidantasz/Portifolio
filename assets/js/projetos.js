function projetos(section) {
  section.innerHTML = `<header>
    ...
    <div class="content">
      <div class="cards">
        <div class="card">
          <h3>Ana Castela - Landing Page</h3>
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/AnaCastela.png"
              alt="Projeto de Landing Page da Ana Castela"
            />
            <div class="buttons">
              <a href="https://github.com/vinidantasz/AnaCastela" target="_blank" title="Repositório no Github">
                <svg
              ...
              <a href="https://vinidantasz.github.io/AnaCastela/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Primeira Landing Page feita por mim no início da carreira de programador.
          </p>
          <p>HTML - CSS</p>
        </div>
        ...
        <div class="card">
          <h3>Mundo das Focas</h3>
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/focas.png"
              alt="Imagem tema do site."
            />
            <div class="buttons">
              <a href="https://github.com/vinidantasz/Focas" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://vinidantasz.github.io/Focas/" id="desafio" title="Ver Projetos">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Site feito sobre focas, sua importância para natureza, fatos legais e etc.
          </p>
          <p>HTML - CSS</p>
        </div>
